.. meta::
   :description: Hmong History Timeline Project
   :keywords: hmong history timeline
   :robots: index, follow
   :abstract: A timeline of Hmong history.
...
.. Hmong History Timeline documentation master file, created by
   sphinx-quickstart on Sat Dec  7 11:00:43 2019.
...
The Hmong History Timeline Project is an attempt to map out bits and pieces of information, scattered through space and time, related to Hmong history and create a timeline. All references and resources should be checked and double-checked. 
...
.. raw:: html
    ...
    <br />
    <br />
    The full source code is available on <a href="https://github.com/oneoffcoder/hht" target="_blank">GitHub</a>.
    <br />
    <br />
    </embed>
...
Cite this book as follows.::
    ...
    @misc{oneoffcoder_hht_2019, 
    title={Hmong History Timeline}, 
    url={https://hht.oneoffcoder.com}, 
    author={Jee Vang}, 
    year={2019}, 
    month={Dec}}
...
This project is dedicated to my grandfather, Yawg Ntsuab Phawv Vaj. 